...
label_4 = Label(root, text="Hobbies",width=20,font=("bold", 10))
label_4.place(x=85,y=330)
var2= IntVar()
Checkbutton(root, text="Badminton", variable=var1).place(x=235,y=330)

Checkbutton(root, text="Cricket", variable=var2).place(x=290,y=330)
